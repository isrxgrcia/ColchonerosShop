...
@section('contenido')
    ...
    {{-- Usamos un bucle @foreach para recorrer la lista de productos destacados y mostrarlos --}}
    <div class="grid-productos reveal">
        @foreach($destacadosHombre as $producto)
            {{-- Reutilizamos el componente 'product-card' para no repetir código en cada ficha --}}
